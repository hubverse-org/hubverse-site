...
: a file that is required to define specific aspects of a [modeling
  ...
  license, time zone, data storage availability) and information concerning
  [model tasks](#model-tasks). The hub administrator constructs these files
  using the [hubverse schema](/tools/data.qmd).
