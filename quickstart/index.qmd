---
title: '<i class="bi bi-question-circle"></i> What is a modeling hub?'
pagetitle: "What is a modeling hub?"
---
...
validation, ensembling, visualization, and evaluation** of model submissions.

One example of a modeling hub is the [FluSight Forecasting
Hub](/community/hubs.qmd#cdc), which collects short-term
forecasts of influenza hospitalizations for US states and territories. Model
output data are submitted weekly from teams in academia, industry, and
government.
...
[{{< fa list-check >}} Create a hub](/quickstart/create.qmd){.btn .btn-outline-dark .ms-auto}
[{{< fa file-export >}} Submit model output](/quickstart/submit.qmd){.btn .btn-outline-dark .ms-auto}
[{{< fa chart-line >}} Analyze Data](/quickstart/analyze.qmd){.btn .btn-outline-dark .ms-auto}
[{{< fa tools >}} Develop software](/quickstart/develop.qmd){.btn .btn-outline-dark .ms-auto}
...
:::: {.page-nav}
::: {.prev-page}
[‹](/index.qmd){.prev-arrow}

[Previous](/index.qmd){.prev-label}

[**Home**](/index.qmd){.prev-title}
:::

::: {.next-page}
[Next](/quickstart/create.qmd){.next-label}

[›](/quickstart/create.qmd){.next-arrow}

[**Create a hub**](/quickstart/create.qmd){.next-title}
:::
::::
