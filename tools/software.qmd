...
[{{< fa book >}} Documentation](https://hubverse.io/en/latest/user-guide/software.html){.btn .btn-outline-dark .ms-auto}
...
[{{< fa box-open >}} hubViz](https://hubverse-org.github.io/hubViz){.btn .btn-outline-info .ms-auto}
...
[{{< fa book >}} Accessing data from a hub](https://hubverse-org.github.io/hubData/articles/connect_hub.html){.btn .btn-outline-dark .ms-auto}
 ...
 - **connect to a hub on S3** with [`hubData::s3_bucket() |> hubdata::connect_hub()`](https://hubverse-org.github.io/hubData/reference/s3_bucket.html)
