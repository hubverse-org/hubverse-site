  ...
  example:
    ...
    hubs:
      ...
      - name: "Name of Hub"
        ...
        # --- OPTIONAL ----
        repo: "example-org/hub-name" # "org/repo" slug, not a URL; for a hub in a subdirectory use "org/repo/tree/branch/subdir"
  ...
  reichlab-modeldev:
    ...
    hubs:
      ...
      - name: "Forecast Sandbox"
        ...
        forecasts: https://reichlab.io/forecast-sandbox-2025-2026-dashboard/forecast.html
        evals: https://reichlab.io/forecast-sandbox-2025-2026-dashboard/eval.html
        count: 25
