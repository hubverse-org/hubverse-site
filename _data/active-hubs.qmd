  ...
  sjfox:
    ...
    hubs:
      - name: "ATSF2026 Training Hub"
        description: |
          A template of a Sandbox hub of forecasts based on the original FluSight Challenge run by the CDC. 
          All data and the repository structure have been formatted according to hubverse standards. 
