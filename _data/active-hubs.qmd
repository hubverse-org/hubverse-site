  ...
  sjfox:
    ...
    hubs:
      - name: "ATSF2026 Training Hub"
        ...
        count: 11
  epistorm:
    logo: /includes/img/epistorm.png
    name: "Center for Advanced Epidemic Analytics and Predictive Modeling Technology (EPISTORM)"
    description: |
      Epistorm transforms data into meaningful analytics insights for informed decision-making and policy formulation. They merge innovative statistical, analytical, and AI techniques with traditional approaches to enhance forecasting and modeling. Epistorm incorporates new data types, such as mobility, airline, genomic, and wastewater information, into advanced models. They have also developed a platform that simulates global air travel and infection patterns to support disease monitoring and prediction.
    hubs:
