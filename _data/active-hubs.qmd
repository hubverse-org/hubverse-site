...
hubs:
    ...
    hubs:
      ...
      - name: "MetroCast Sandbox"
        ...
        contact:
          - name: "Nick Reich"
            email: "nick@umass.edu"
        repo: "reichlab/metrocast-sandbox-2025-2026" # must be slug, not URL
        license: "MIT License"
        count: 7
  reichlab-training:
    logo: /includes/img/reichlab.png
  ...
  dailypartita:
    ...
    hubs:
      - name: "China COVID-19 Prediction Center"
        description: "This collaborative prediction platform collects and evaluates real-time predictions of SARS-CoV-2 positivity rates \nin influenza-like illness cases from sentinel hospitals in China. \nThe platform provides evidence-based insights for comparing prediction models and supporting public health decision-making.\n"
        contact:
          - name: Kaixin Yang
