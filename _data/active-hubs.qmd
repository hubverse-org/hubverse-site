  ...
  bleicham:
    ...
    hubs:
      - name: "SISMID Human-AI Teaming Forecast Challenge Sandbox"
        description: "A sandbox forecasting challenge for the SISMID Human-AI Teaming Approach to Infectious Disease Modeling lab. It is modeled on the US CDC's FluSight challenge and built to hubverse standards, so that participants can work through a real collaborative-forecasting pipeline end to end: from raw surveillance data, to a submitted probabilistic forecast, to an evaluated, directly comparable score."
        contact:
