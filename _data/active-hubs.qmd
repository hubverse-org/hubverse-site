  ...
  hubverse:
    ...
    hubs:
      - name: "Archival FluSight hub (2015--2019)"
        description: "original FluSight Forecast submissions (https://github.com/cdcepi/FluSight-forecasts), reformatted to align with the hubverse format. \n"
        # from admin.json
        contact:
          - name: "Luke Mullany"
  ...
  reichlab-modeldev:
    ...
    hubs:
      ...
      - name: "MetroCast Sandbox"
        description: "Hub serving as a sandbox/testbed for experimental [Metrocast forecasts](https://github.com/reichlab/flu-metrocast/tree/main) before and during the 2025/2026 respiratory virus forecasting season.\n"
        # from admin.json
        contact:
          - name: "Nick Reich"
            email: "nick@umass.edu"
  ...
  reichlab-training:
    ...
    hubs:
      - name: "SISMID ILI Forecasting Sandbox"
        description: "Sandbox hub providing an environment for training, research, or benchmarking purposes. \n"
        # from admin.json
        contact:
          - name: "Nick Reich"
            email: "nick@umass.edu"
