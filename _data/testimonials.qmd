...
sjf:
  ...
  testimonial: |
    ...
    that have historically lacked access to real-time forecasts. Their standardized, flexible infrastructure makes it possible to
    rapidly deploy and coordinate forecasting efforts across many regions.
alfa:
  hub: Alfa Hub
  name: Dr. Alfa
