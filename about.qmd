---
title: '<i class="bi bi-info-circle-fill"></i> About the hubverse'
pagetitle: "About the hubverse"
---
...
Building off of systems designed for influenza forecasting challenges led by the US CDC, the [Reich Lab at UMass-Amherst](https://reichlab.io/), in collaboration with the [US CDC](https://www.cdc.gov/), developed the [US COVID-19 Forecast Hub](https://covid19forecasthub.org/) in early 2020 to support COVID-19 forecasting efforts. This infrastructure was later adapted for use by several other modeling hubs:
 ...
 - [European COVID-19 Forecast Hub](https://github.com/european-modelling-hubs/covid19-forecast-hub-europe_archive)
...
<img src="/includes/img/hubverse-retreat-2023-1.jpg" alt="Photo of nine smiling people standing on stairs leading to the front entrance to a building." class="inline-photo">

The first "hubverse retreat" was held June 5-9, 2023 at the University of Massachusetts, Amherst. It focused on laying the groundwork for the hubverse, including documentation, Zoltar integration, and software development.

<img src="/includes/img/hubverse-retreat-2024-1.jpg" alt="Photo of eleven smiling people standing on stairs leading to the front entrance to a building called Arnold." class="inline-photo">
...
<img src="/includes/img/hubverse-retreat-2025-1.jpg" alt="Photo of three women working on their laptops on a desk." class="inline-photo">

The third "hubverse retreat" was held October 14-17, 2025, at the University of Massachusetts, Amherst. During the retreat we worked on [finishing and readying the release of the v6.0.0 schema](https://github.com/hubverse-org/schemas/issues/136) that formalizes target data (among other improvements), adding sample functionality and other features to hubVis, coding hubdata python versions of timeseries functions, and developing a more productive relationship with Claude.


:::: {.page-nav}
::: {.prev-page}
[‹](/contact.qmd){.prev-arrow}

[Previous](/contact.qmd){.prev-label}

[**Contact**](/contact.qmd){.prev-title}
:::

::: {.next-page}
[Next](/terminology.qmd){.next-label}

[›](/terminology.qmd){.next-arrow}

[**Terminology**](/terminology.qmd){.next-title}
:::
::::
