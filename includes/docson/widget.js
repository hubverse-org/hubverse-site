...
// ZNK: instead of searching the document for "script" tags (as the previous
//      iteration was), it's better to add a class to the tags and use that. 
var scripts = document.getElementsByClassName('docson');
