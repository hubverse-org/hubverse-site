...
There are currently four pages that contain pre-computed content, which is 
...
4. `cite.qmd` is generated by
   [scripts/update-cite.py](scripts/update-cite.py). This script auto-generates a page with
